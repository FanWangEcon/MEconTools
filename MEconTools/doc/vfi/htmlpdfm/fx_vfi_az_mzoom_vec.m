...
% 
% This is the example vignette for function:<https://github.com/FanWangEcon/MEconTools/blob/master/MEconTools/vfi/ff_vfi_az_mzoom_vec.m  
% *ff_vfi_az_mzoom_vec*> from the <https://fanwangecon.github.io/MEconTools/ *MEconTools 
% Package*>*.* This function solves the dynamic programming problem for a (a,z) 
% model. The state-space is on a grid, but choice grids are in terms of percentage 
% of resources to save and solved exactly. 
% 
% This is a *vectorized* code for *continuous* choices, solved with the <https://fanwangecon.github.io/MEconTools/MEconTools/doc/optim/htmlpdfm/fx_optim_mzoom_savezrone.html 
