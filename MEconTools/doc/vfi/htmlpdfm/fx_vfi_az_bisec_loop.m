%% FF_VFI_AZ_BISEC_LOOP Savings Loop Exact (FOC) Examples
...
% 
% The code uses *continuous* choices, solved with bisection. The state-space 
% is on a grid, but choice grids are in terms of *percentage of resources* to 
% save and solved exactly.
% 
% *Links to Other Code:*
% 
