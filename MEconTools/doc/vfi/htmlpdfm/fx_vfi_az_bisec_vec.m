%% FF_VFI_AZ_BISEC_VEC Savings Vectorized Exact (FOC) Examples
...
% choice set and state space share the same grid. The common grid function is 
% faster, but less precise for the same number of asset grid points.
% 
% *Links to Other Code:*
% 
