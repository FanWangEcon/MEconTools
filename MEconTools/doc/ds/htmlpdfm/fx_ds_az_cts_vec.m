...
% 
% This is the example vignette for function: <https://github.com/FanWangEcon/MEconTools/blob/master/MEconTools/vfi/ff_ds_az_cts_vec.m 
% *ff_ds_az_cts_vec*> from the <https://fanwangecon.github.io/MEconTools/ *MEconTools 
% Package*>*.* F(a,z) discrete probability mass function given policy function 
% solution with continuous savings choices, vectorized.
%% 
