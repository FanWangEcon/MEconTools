...
% 
% This is the example vignette for function: <https://github.com/FanWangEcon/MEconTools/blob/master/MEconTools/vfi/ff_ds_az_loop.m 
% *ff_ds_az_loop*> from the <https://fanwangecon.github.io/MEconTools/ *MEconTools 
% Package*>*.* F(a,z) discrete probability mass function given policy function 
% solution with discretized savings choices.
%% 
% * Distribution for Common Choice and States Grid _*Loop*_: <https://github.com/FanWangEcon/MEconTools/blob/master/MEconTools/vfi/ff_ds_az_loop.m 
% *ff_ds_az_loop*>
